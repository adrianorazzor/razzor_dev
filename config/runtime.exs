...
#
#     PHX_SERVER=true bin/razzor_dev start
#
...
if config_env() == :prod do
  ...
  secret_key_base =
   ...
   # Configure the Endpoint URL and HTTP settings dynamically
   host = System.get_env("PHX_HOST") || "your-default-domain.com"
  ...
  #
  #     config :razzor_dev, RazzorDev.Mailer,
