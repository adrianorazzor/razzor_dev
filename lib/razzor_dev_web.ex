defmodule RazzorDevWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: RazzorDevWeb.Layouts]

      import Plug.Conn
      import RazzorDevWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import RazzorDevWeb.CoreComponents
      import RazzorDevWeb.Gettext
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: RazzorDevWeb.static_paths()
    end
  end
